    ...
    if counterlogin==1:
        ...
        def appointment():
            ...
            if counterappointment==1:
                ...
                labelappointment=Label(frameappointmentleft,text="Appointment:-",bg="orange",fg="black",font=("Times new roman",30,"bold"))
                ...
                patintnoappointment=Label(frameappointmentlef,text="Appointment No:",bg="orange",font=("Times new roman",20,"bold"))
                patintnoappointment.grid(row=0,column=0)

                PATIENTNOAPPOINTMENT=StringVar()
                entrypatientnoappointment=Entry(frameappointmentlef,textvariable=PATIENTNOAPPOINTMENT,font=("Times new roman",20,"bold"))
                entrypatientnoappointment.grid(row=0,column=1)

                patientnameappointment=Label(frameappointmentlef,text="Patient Name:    ",bg="orange",font=("Times new roman",20,"bold"))
                patientnameappointment.grid(row=1,column=0,pady=20)

                PATIENTNAMEAPPOINTMENT=StringVar()
                entrymenucode=Entry(frameappointmentlef,textvariable=PATIENTNAMEAPPOINTMENT,font=("Times new roman",20,"bold"))
                ...
                labelGender=Label(frameappointmentlef,text="Gender:               ",bg="orange",font=("Times new roman",20,"bold"))
                labelGender.grid(row=2,column=0)

                i= IntVar()
                r1 = Radiobutton(frameappointmentlef,text="male",value='Male',variable=GENDERAPPOINTMENT,bg="orange",font=("Times new roman",20,"bold"))
                r2 = Radiobutton(frameappointmentlef,text="female",value='Female',variable=GENDERAPPOINTMENT,bg="orange",font=("Times new roman",20,"bold"))
                r1.grid(row=2,column=1,sticky="w")
                r2.grid(row=2,column=1,sticky="e",padx=0)

                labelItemName=Label(frameappointmentlef,text="Age:                 ",bg="orange",font=("Times new roman",20,"bold"))
                labelItemName.grid(row=3,column=0,pady=20) 

                AGEAPPOINTMENT=StringVar()
                entryitemname=Entry(frameappointmentlef,textvariable=AGEAPPOINTMENT,font=("Times new roman",20,"bold"))
                entryitemname.grid(row=3,column=1,pady=20)


                labelQuantity=Label(frameappointmentlef,text="Phone No:         ",bg="orange",font=("Times new roman",20,"bold"))
                labelQuantity.grid(row=4,column=0,pady=20)

                PHONENOAPPOINTMENT=StringVar()
                entryquantity=Entry(frameappointmentlef,textvariable=PHONENOAPPOINTMENT,font=("Times new roman",20,"bold"))
                entryquantity.grid(row=4,column=1,pady=20)

                labelItemName=Label(frameappointmentlef,text="Address:         ",bg="orange",font=("Times new roman",20,"bold"))
                labelItemName.grid(row=5,column=0,pady=20)

                ADDRESSAPPOINTMENT=StringVar()
                entryitemname=Entry(frameappointmentlef,textvariable=ADDRESSAPPOINTMENT,font=("Times new roman",20,"bold"))
                entryitemname.grid(row=5,column=1,pady=20)

                labelGender=Label(frameappointmentlef,text="Time/Date:        ",bg="orange",font=("Times new roman",20,"bold"))
                labelGender.grid(row=6,column=0,pady=20)

                APPOINTMENTTIME=StringVar()
                entryfname=Entry(frameappointmentlef,textvariable=APPOINTMENTTIME,font=("Times new roman",20,"bold"))
                entryfname.grid(row=6,column=1,pady=20)

                buttonADD=Button(frameappointmentlef,text="Add",command=SubmitAppointment,bg="black",fg="orange",width="12",font=("Times new roman",20))
                buttonADD.grid(row=7,column=0,sticky="e")

                buttonUpdate=Button(frameappointmentlef,text="Update",command=updateappointment,bg="black",fg="orange",width="12",font=("Times new roman",20))
                ...
                Edititem=Label(frameappointmentrecord,text="Appointment List:-",fg="black",font=("Times new roman",30,"bold"))
        ...
        def billrecord():
            ...
            if counterbillrecord==1:
                framebillrecord=Frame(root,relief="solid",borderwidth=2,bg="lightblue")
                ...
                labelbill=Label(frameybillr,text="Bill Record",bg="sandybrown",fg="black",font=("Times new roman",20,"bold"))
                labelbill.pack()

                frameq=Frame(framebillrecord,width=100,relief="solid",borderwidth=2,bg="lightblue")
                frameq.pack(side="left",fill=Y)

                labelinputid=Label(frameq,text="Input Patient id",fg="black",bg="lightblue",font=("Times new roman",20,"bold"))
                labelinputid.pack(side=TOP)

                searchbillrecord=StringVar()
                Username=Entry(frameq,width="17",textvariable=searchbillrecord,font=("Times new roman",15,"bold"))
                Username.pack()      

                Searchbutton=Button(frameq,text="Search",command=lambda:Blsearch(searchbillrecord.get()),bg="yellow",font=("Times new roman",15,"bold"))
                ...
                frametbill=Frame(framebillrecord,height="200",bg="lightblue")
                frametbill.pack(side=TOP,fill=X)

                framebrleft=Frame(frametbill,height="200",width="685",bg="lightblue")
                framebrleft.pack(side=LEFT)

                labelPatient_id=Label(framebrleft,text="Identity:",bg="lightblue",font=("Times new roman",16,"bold"))
                labelPatient_id.grid(row=0,column=0,sticky="w",padx="30",pady=2)

                BlrecordIdentity=StringVar()
                Identity=Entry(framebrleft,textvariable=BlrecordIdentity,font=("Times new roman",16,"bold"))
                Identity.grid(row=0,column=1)

                labelName=Label(framebrleft,text="Name:",bg="lightblue",font=("Times new roman",16,"bold"))
                labelName.grid(row=1,column=0,sticky="w",padx="30")

                BlrecordName=StringVar()
                Name=Entry(framebrleft,textvariable=BlrecordName,font=("Times new roman",16,"bold"))
                Name.grid(row=1,column=1)

                GenderBlrecord=StringVar() 
                GenderBlrecord.set("")  

                labelGender=Label(framebrleft,text="Gender:  ",bg="lightblue",font=("Times new roman",16,"bold"))
                labelGender.grid(row=2,column=0)
                                
                i= IntVar()
                r1 = Radiobutton(framebrleft,text="male",value='Male',variable=GenderBlrecord,bg="lightblue",font=("Times new roman",16,"bold"))
                r2 = Radiobutton(framebrleft,text="female",value='Female',variable=GenderBlrecord,bg="lightblue",font=("Times new roman",16,"bold"))
                r1.grid(row=2,column=1,sticky="w")
                r2.grid(row=2,column=1,sticky="e",padx=0)
                GenderBlrecord.set(3)


                labelAge=Label(framebrleft,text="Age:",bg="lightblue",font=("Times new roman",16,"bold"))
                labelAge.grid(row=3,column=0,sticky="w",padx="30")

                BlrecordAge=StringVar()
                Age=Entry(framebrleft,textvariable=BlrecordAge,font=("Times new roman",16,"bold"))
                Age.grid(row=3,column=1)

                labelCheckIn=Label(framebrleft,text="Check In:",bg="lightblue",font=("Times new roman",16,"bold"))
                labelCheckIn.grid(row=4,column=0,sticky="w",padx="30")

                Blrecordcheckin=StringVar()
                checkin=Entry(framebrleft,textvariable=Blrecordcheckin,font=("Times new roman",16,"bold"))
                ...
                framebrights=Frame(frametbill,height="200",bg="lightblue",width="685")
                framebrights.pack(side=RIGHT)

                labelAge=Label(framebrights,text="Disease:",bg="lightblue",font=("Times new roman",16,"bold"))
                labelAge.grid(row=0,column=0,sticky="w",padx=20)

                BlrecordDisease=StringVar()
                Disease=Entry(framebrights,textvariable=BlrecordDisease,font=("Times new roman",16,"bold"))
                Disease.grid(row=0,column=1,padx="0")

                labelPhone=Label(framebrights,text="Phone:",bg="lightblue",font=("Times new roman",16,"bold"))
                labelPhone.grid(row=1,column=0,sticky="w",padx=20)

                BlrecordPhone=StringVar()
                Phone=Entry(framebrights,textvariable=BlrecordPhone,font=("Times new roman",16,"bold"))
                Phone.grid(row=1,column=1,padx="30")

                labelAddress=Label(framebrights,text="Address:",bg="lightblue",font=("Times new roman",16,"bold"))
                labelAddress.grid(row=2,column=0,sticky="w",padx=20)

                BlrecordAddress=StringVar()
                Address=Entry(framebrights,textvariable=BlrecordAddress,font=("Times new roman",16,"bold"))
                Address.grid(row=2,column=1,padx="30")

                labelDisease=Label(framebrights,text="Doctor Name:",bg="lightblue",font=("Times new roman",16,"bold"))
                labelDisease.grid(row=3,column=0,sticky="w",padx=20)

                BlrecordDoctorname=StringVar()
                Doctorname=Entry(framebrights,textvariable=BlrecordDoctorname,font=("Times new roman",16,"bold"))
                Doctorname.grid(row=3,column=1,padx="30")

                labelCheckOut=Label(framebrights,text="Check Out:",bg="lightblue",font=("Times new roman",16,"bold"))
                labelCheckOut.grid(row=4,column=0,sticky="w",padx=20)

                Blrecordcheckout=StringVar()
                checkout=Entry(framebrights,textvariable=Blrecordcheckout,font=("Times new roman",16,"bold"))
                ...
                framebottomr=Frame(framebillrecord,relief="solid",bg="lightblue",borderwidth=2)
                framebottomr.pack(side=TOP,fill=X,pady=16)

                labelPatient_id=Label(framebottomr,text="Sr. No :",bg="lightblue",fg="Purple",font=("Times new roman",20,"bold"))
                labelPatient_id.grid(row=0,column=0,sticky="w",padx=60)
                labelPatient_id=Label(framebottomr,text="Particulars :",bg="lightblue",fg="Purple",font=("Times new roman",20,"bold"))
                labelPatient_id.grid(row=0,column=1,sticky="w",padx=60)
                labelPatient_id=Label(framebottomr,text="Amount :",bg="lightblue",fg="Purple",font=("Times new roman",20,"bold"))
                ...
                framebox=Frame(framebillrecord,bg="lightblue")
                framebox.pack(side=TOP,fill=BOTH,expand=True,pady="10")

                labelPatient_id=Label(framebox,text="01 :",bg="lightblue",font=("Times new roman",17,"bold"))
                labelPatient_id.grid(row=0,column=0,sticky="w",padx=70)
                labelPatient_id=Label(framebox,text="Doctor Charges:",bg="lightblue",font=("Times new roman",17,"bold"))
                labelPatient_id.grid(row=0,column=1,sticky="w",padx=45)

                BlrecordDoctorcharges=StringVar()
                Doctorcharges=Entry(framebox,textvariable=BlrecordDoctorcharges,font=("Times new roman",17,"bold"))
                Doctorcharges.grid(row=0,column=2,sticky="w")

                labelName=Label(framebox,text="02 :",bg="lightblue",font=("Times new roman",17,"bold"))
                labelName.grid(row=1,column=0,sticky="w",padx=70)
                labelName=Label(framebox,text="Lab Test:",bg="lightblue",font=("Times new roman",17,"bold"))
                labelName.grid(row=1,column=1,sticky="w",padx=45)

                BlrecordLabtest=StringVar()
                Labtest=Entry(framebox,textvariable=BlrecordLabtest,font=("Times new roman",17,"bold"))
                Labtest.grid(row=1,column=2,sticky="w")

                labelGender=Label(framebox,text="03 :",bg="lightblue",font=("Times new roman",17,"bold"))
                labelGender.grid(row=2,column=0,sticky="w",padx=70)
                labelGender=Label(framebox,text="Treatment Charges:",bg="lightblue",font=("Times new roman",17,"bold"))
                labelGender.grid(row=2,column=1,sticky="w",padx=45)

                TreatmentchargesBlrecord=StringVar()
                Treatmentcharges=Entry(framebox,textvariable=TreatmentchargesBlrecord,font=("Times new roman",17,"bold"))
                Treatmentcharges.grid(row=2,column=2,sticky="w")

                labelAge=Label(framebox,text="04 :",bg="lightblue",font=("Times new roman",17,"bold"))
                labelAge.grid(row=3,column=0,sticky="w",padx=70)
                labelAge=Label(framebox,text="Procedure Charges:",bg="lightblue",font=("Times new roman",17,"bold"))
                labelAge.grid(row=3,column=1,sticky="w",padx=45)

                BlrecordProcedurecharges=StringVar()
                Procedurecharges=Entry(framebox,textvariable=BlrecordProcedurecharges,font=("Times new roman",17,"bold"))
                Procedurecharges.grid(row=3,column=2,sticky="w")

                labelPhone=Label(framebox,text="05 :",bg="lightblue",font=("Times new roman",17,"bold"))
                labelPhone.grid(row=4,column=0,sticky="w",padx=70)
                labelPhone=Label(framebox,text="Other Charges:",bg="lightblue",font=("Times new roman",17,"bold"))
                labelPhone.grid(row=4,column=1,sticky="w",padx=45)

                BlrecordOthercharges=StringVar()
                Othercharges=Entry(framebox,font=("Times new roman",17,"bold"),textvariable=BlrecordOthercharges)
                Othercharges.grid(row=4,column=2,sticky="w")

                labelAddress=Label(framebox,text="06 :",bg="lightblue",font=("Times new roman",17,"bold"))
                labelAddress.grid(row=5,column=0,sticky="w",padx=70)
                labelAddress=Label(framebox,text="Miscellaneous Charges:",bg="lightblue",font=("Times new roman",17,"bold"))
                labelAddress.grid(row=5,column=1,sticky="w",padx=45)

                BlrecordMiscellaneouscharges=StringVar()
                Miscellaneouscharges=Entry(framebox,textvariable=BlrecordMiscellaneouscharges,font=("Times new roman",17,"bold"))
                Miscellaneouscharges.grid(row=5,column=2,sticky="w")

                labelAddress=Label(framebox,text="07 :",bg="lightblue",font=("Times new roman",17,"bold"))
                labelAddress.grid(row=6,column=0,sticky="w",padx=70)
                labelAddress=Label(framebox,text="Room Charges:",bg="lightblue",font=("Times new roman",17,"bold"))
                labelAddress.grid(row=6,column=1,sticky="w",padx=45)

                BlrecordRoomcharges=StringVar()
                Roomcharges=Entry(framebox,textvariable=BlrecordRoomcharges,font=("Times new roman",17,"bold"))
                Roomcharges.grid(row=6,column=2,sticky="w") 

                labelDisease=Label(framebox,text="",bg="lightblue",font=("Times new roman",17,"bold"))
                labelDisease.grid(row=7,column=0,sticky="w",padx=105)
                labelDisease=Label(framebox,text="Total:",fg="red",bg="lightblue",font=("Times new roman",17,"bold"))
                labelDisease.grid(row=7,column=1,sticky="w",padx=45)

                BlrecordTotal=StringVar()
                Total=Entry(framebox,textvariable=BlrecordTotal,font=("Times new roman",17,"bold"))
        ...
        def Bill():
            ...
            try:
                ...
                pass
            if counterbill==1:
                framebill=Frame(root,relief="solid",borderwidth=2,bg="lightblue")
                framebill.pack(side="right",fill=BOTH,expand=True)

                framerecordleft=Frame(framebill,height="60",width="200",relief="solid",borderwidth=2,bg="lightblue")
                ...
                labelinputpatientname=Label(framepatientbilltop,text="Input Patient's ID",bg="sandybrown",font=("Times new roman",16,"bold"))
                labelinputpatientname.pack(anchor=CENTER,pady=6)

                framepatientadmittopsearch=Frame(framerecordleft,bg="lightblue")
                framepatientadmittopsearch.pack(side=TOP)

                searchID=StringVar()
                inputpatientname=Entry(framepatientadmittopsearch,textvariable=searchID,width="15",font=("Times new roman",15,"bold"))
                inputpatientname.pack(pady=10)

                Searchbutton=Button(framepatientadmittopsearch,text="Search",command=lambda:Billsearch(searchID.get()),bg="yellow",font=("Times new roman",15,"bold"))
                Searchbutton.pack(side=TOP,pady=8)

                framexbill=Frame(framebill,bg="sandybrown",relief="solid",borderwidth=2)
                framexbill.pack(side=TOP,fill=X)

                labelbill=Label(framexbill,text="Billing",bg="sandybrown",fg="black",font=("Times new roman",20,"bold"))
                labelbill.pack()

                frametbill=Frame(framebill,height="200",bg="lightblue")
                frametbill.pack(side=TOP,fill=X)

                framebleft=Frame(frametbill,height="200",width="685",bg="lightblue")
                framebleft.pack(side=LEFT)

                labelPatient_id=Label(framebleft,text="Identity:",bg="lightblue",font=("Times new roman",17,"bold"))
                labelPatient_id.grid(row=0,column=0,sticky="w",padx="50",pady=2)

                BlIdentity=StringVar()
                Identity=Entry(framebleft,textvariable=BlIdentity,font=("Times new roman",16,"bold"))
                Identity.grid(row=0,column=1)

                labelName=Label(framebleft,text="Name:",bg="lightblue",font=("Times new roman",17,"bold"))
                labelName.grid(row=1,column=0,sticky="w",padx="50")

                BlName=StringVar()
                Name=Entry(framebleft,textvariable=BlName,font=("Times new roman",16,"bold"))
                Name.grid(row=1,column=1)

                GenderBl=StringVar() 
                GenderBl.set("")

                labelGender=Label(framebleft,text="Gender:  ",bg="lightblue",font=("Times new roman",17,"bold"))
                labelGender.grid(row=2,column=0)
                                
                i= IntVar()
                r1 = Radiobutton(framebleft,text="male",value='Male',variable=GenderBl,bg="lightblue",font=("Times new roman",16,"bold"))
                r2 = Radiobutton(framebleft,text="female",value='Female',variable=GenderBl,bg="lightblue",font=("Times new roman",16,"bold"))
                r1.grid(row=2,column=1,sticky="w")
                r2.grid(row=2,column=1,sticky="e",padx=0)
                GenderBl.set(3)

                labelAge=Label(framebleft,text="Age:",bg="lightblue",font=("Times new roman",17,"bold"))
                labelAge.grid(row=3,column=0,sticky="w",padx="50")

                BlAge=StringVar()
                Age=Entry(framebleft,textvariable=BlAge,font=("Times new roman",16,"bold")) 
                Age.grid(row=3,column=1)

                checkin=Label(framebleft,text="Check In:",bg="lightblue",font=("Times new roman",17,"bold"))
                checkin.grid(row=4,column=0,sticky="w",padx="50")

                Blcheckin=StringVar()
                checkin=Entry(framebleft,textvariable=Blcheckin,font=("Times new roman",16,"bold"))
                checkin.grid(row=4,column=1)
                ...
                framebright=Frame(frametbill,height="200",bg="lightblue",width="685")
                framebright.pack(side=RIGHT)

                labelAge=Label(framebright,text="Disease:",bg="lightblue",font=("Times new roman",17,"bold"))
                labelAge.grid(row=0,column=0,sticky="w")

                BlDisease=StringVar()
                Disease=Entry(framebright,textvariable=BlDisease,font=("Times new roman",16,"bold"))
                Disease.grid(row=0,column=1,padx="50")

                labelPhone=Label(framebright,text="Phone:",bg="lightblue",font=("Times new roman",17,"bold"))
                labelPhone.grid(row=1,column=0,sticky="w")

                BlPhone=StringVar()
                Phone=Entry(framebright,textvariable=BlPhone,font=("Times new roman",16,"bold"))
                Phone.grid(row=1,column=1,padx="50")

                labelAddress=Label(framebright,text="Address:",bg="lightblue",font=("Times new roman",17,"bold"))
                labelAddress.grid(row=2,column=0,sticky="w")

                BlAddress=StringVar()
                Address=Entry(framebright,textvariable=BlAddress,font=("Times new roman",16,"bold"))
                Address.grid(row=2,column=1,padx="50")

                labelDisease=Label(framebright,text="Doctor Name:",bg="lightblue",font=("Times new roman",17,"bold"))
                labelDisease.grid(row=3,column=0,sticky="w")

                BlDoctorname=StringVar() 
                Doctorname=Entry(framebright,textvariable=BlDoctorname,font=("Times new roman",16,"bold"))
                Doctorname.grid(row=3,column=1,padx="50")

                labelCheckOut=Label(framebright,text="Check Out:",bg="lightblue",font=("Times new roman",17,"bold"))
                labelCheckOut.grid(row=4,column=0,sticky="w")

                Blcheckout=StringVar() 
                Doctorname=Entry(framebright,textvariable=Blcheckout,font=("Times new roman",16,"bold"))
                ...
                framebottom=Frame(framebill,relief="solid",bg="lightblue",borderwidth=2)
                framebottom.pack(side=TOP,fill=X,pady=16)

                labelPatient_id=Label(framebottom,text="Sr. No :",bg="lightblue",fg="Purple",font=("Times new roman",20,"bold"))
                labelPatient_id.grid(row=0,column=0,sticky="w",padx=55)
                labelPatient_id=Label(framebottom,text="Particulars :",bg="lightblue",fg="Purple",font=("Times new roman",20,"bold"))
                labelPatient_id.grid(row=0,column=1,sticky="w",padx=10)
                labelPatient_id=Label(framebottom,text="Amount :",bg="lightblue",fg="Purple",font=("Times new roman",20,"bold"))
                ...
                framebo=Frame(framebill,bg="lightblue")
                framebo.pack(side=TOP,fill=BOTH,expand=True,pady="10")

                labelPatient_id=Label(framebo,text="01 :",bg="lightblue",font=("Times new roman",17,"bold"))
                labelPatient_id.grid(row=0,column=0,sticky="w",padx=75)
                labelPatient_id=Label(framebo,text="Doctor Charges:",bg="lightblue",font=("Times new roman",17,"bold"))
                labelPatient_id.grid(row=0,column=1,sticky="w",padx=10)

                BlDoctorcharges=StringVar()
                Doctorcharges=Entry(framebo,textvariable=BlDoctorcharges,font=("Times new roman",17,"bold"))
                Doctorcharges.grid(row=0,column=2,sticky="w",padx=40)

                labelName=Label(framebo,text="02 :",bg="lightblue",font=("Times new roman",17,"bold"))
                labelName.grid(row=1,column=0,sticky="w",padx=75)
                labelName=Label(framebo,text="Lab Test:",bg="lightblue",font=("Times new roman",17,"bold"))
                labelName.grid(row=1,column=1,sticky="w",padx=10)

                BlLabtest=StringVar()
                Labtest=Entry(framebo,textvariable=BlLabtest,font=("Times new roman",17,"bold"))
                Labtest.grid(row=1,column=2,sticky="w",padx=40)

                labelGender=Label(framebo,text="03 :",bg="lightblue",font=("Times new roman",17,"bold"))
                labelGender.grid(row=2,column=0,sticky="w",padx=75)
                labelGender=Label(framebo,text="Treatment Charges:",bg="lightblue",font=("Times new roman",17,"bold"))
                labelGender.grid(row=2,column=1,sticky="w",padx=10)

                TreatmentchargesBl=StringVar() 
                Treatmentcharges=Entry(framebo,textvariable=TreatmentchargesBl,font=("Times new roman",17,"bold"))
                Treatmentcharges.grid(row=2,column=2,sticky="w",padx=40)

                labelAge=Label(framebo,text="04 :",bg="lightblue",font=("Times new roman",17,"bold"))
                labelAge.grid(row=3,column=0,sticky="w",padx=75)
                labelAge=Label(framebo,text="Procedure Charges:",bg="lightblue",font=("Times new roman",17,"bold"))
                labelAge.grid(row=3,column=1,sticky="w",padx=10)

                BlProcedurecharges=StringVar()
                Procedurecharges=Entry(framebo,textvariable=BlProcedurecharges,font=("Times new roman",17,"bold"))
                Procedurecharges.grid(row=3,column=2,sticky="w",padx=40)

                labelPhone=Label(framebo,text="05 :",bg="lightblue",font=("Times new roman",17,"bold"))
                labelPhone.grid(row=4,column=0,sticky="w",padx=75)
                labelPhone=Label(framebo,text="Other Charges:",bg="lightblue",font=("Times new roman",17,"bold"))
                labelPhone.grid(row=4,column=1,sticky="w",padx=10)

                BlOthercharges=StringVar()
                Othercharges=Entry(framebo,font=("Times new roman",17,"bold"),textvariable=BlOthercharges)
                Othercharges.grid(row=4,column=2,sticky="w",padx=40)

                labelAddress=Label(framebo,text="06 :",bg="lightblue",font=("Times new roman",17,"bold"))
                labelAddress.grid(row=5,column=0,sticky="w",padx=75)
                labelAddress=Label(framebo,text="Miscellaneous Charges:",bg="lightblue",font=("Times new roman",17,"bold"))
                labelAddress.grid(row=5,column=1,sticky="w",padx=10)

                BlMiscellaneouscharges=StringVar()
                Miscellaneouscharges=Entry(framebo,textvariable=BlMiscellaneouscharges,font=("Times new roman",17,"bold"))
                Miscellaneouscharges.grid(row=5,column=2,sticky="w",padx=40)

                labelAddress=Label(framebo,text="07 :",bg="lightblue",font=("Times new roman",17,"bold"))
                labelAddress.grid(row=6,column=0,sticky="w",padx=75)
                labelAddress=Label(framebo,text="Room Charges:",bg="lightblue",font=("Times new roman",17,"bold"))
                labelAddress.grid(row=6,column=1,sticky="w",padx=10)

                BlRoomcharges=StringVar()
                Roomcharges=Entry(framebo,textvariable=BlRoomcharges,font=("Times new roman",17,"bold"))
                Roomcharges.grid(row=6,column=2,sticky="w",padx=40)

                labelDisease=Label(framebo,text="",bg="lightblue",font=("Times new roman",17,"bold"))
                labelDisease.grid(row=7,column=0,sticky="w",padx=75)
                labelDisease=Button(framebo,text="Total:",command=total,bg="orange",font=("Times new roman",17,"bold"))
                labelDisease.grid(row=7,column=1,sticky="w",padx=10)

                BlTotal=StringVar()
                Total=Entry(framebo,textvariable=BlTotal,font=("Times new roman",17,"bold"))
                ...
                frameprint=Frame(framebill,bg="lightblue")
                frameprint.pack(side=RIGHT)

                buttonadd=Button(frameprint,text="SAVE",bg="yellow",command=savebill,bd=3,width=10,font=("Times new roman",15,"bold"))
                buttonadd.pack(side=LEFT)

                buttonPrint=Button(frameprint,text="Print",bg="yellow",command=printbill,bd=3,width=10,font=("Times new roman",15,"bold"))
        ...
        def sinfo():
            ...
            if countersinfo==1:
                framestaffinformation=Frame(root,bg="lightblue",)
                ...
                labelstaffinformation=Label(framestaffinformationtop,text="Staff Information",bg="sandybrown",font=("Times new roman",23,"bold"))
                labelstaffinformation.pack(anchor="center")

                framestaffinformationleft=Frame(framestaffinformation,height="60",width="300",bg="lightblue",relief="solid",borderwidth=2)
                framestaffinformationleft.pack(side=LEFT,fill=Y)

                labelUsername=Label(framestaffinformationleft,text="User ID",bg="lightblue",font=("Times new roman",20,"bold"))
                labelUsername.pack(anchor=CENTER,pady=20)
                
                searchID=StringVar()
                Username=Entry(framestaffinformationleft,width="20",textvariable=searchID,font=("Times new roman",15,"bold"))
                Username.pack()

                Searchbutton=Button(framestaffinformationleft,text="Search",command=lambda:Sisearch(searchID.get()),bg="yellow",font=("Times new roman",15,"bold"))
                Searchbutton.pack(side=TOP,pady=8)

                framestaffinformationright=Frame(framestaffinformation,height="60",bg="lightblue",width="300",relief="solid",borderwidth=2)
                framestaffinformationright.pack(side=RIGHT,fill=Y)

                buttonUpdate=Button(framestaffinformationright,text="Update",command=Siupdate,bd=7,bg="yellow",width=10,font=("Times new roman",15,"bold"))
                buttonUpdate.pack(side=TOP,padx="70",pady=100)



                framestaffinformationcenter=Frame(framestaffinformation,height="60",width="130",bg="lightblue",relief="solid",borderwidth=2)
                framestaffinformationcenter.pack(anchor="center",fill=BOTH,expand=True)

                labelid=Label(framestaffinformationcenter,text="ID:                 ",bg="lightblue",font=("Times new roman",20,"bold"))
                labelid.grid(row=0,column=0,padx=10,pady=15)

                SiID=StringVar()
                ID=Entry(framestaffinformationcenter,textvariable=SiID,font=("Times new roman",20,"bold"))
                ID.grid(row=0,column=1,padx=0)

                labelName=Label(framestaffinformationcenter,text="Name:            ",bg="lightblue",font=("Times new roman",20,"bold"))
                labelName.grid(row=1,column=0,padx=10,pady=15)
                
                SiName=StringVar()
                Name=Entry(framestaffinformationcenter,textvariable=SiName,font=("Times new roman",20,"bold"))
                Name.grid(row=1,column=1,padx=0)

                GenderSi=StringVar()
                GenderSi.set("")

                labelGender=Label(framestaffinformationcenter,text="Gender:          ",bg="lightblue",font=("Times new roman",20,"bold"))
                labelGender.grid(row=2,column=0)
                        
                r1 = Radiobutton(framestaffinformationcenter,text="male",value='Male',bg="lightblue",variable=GenderSi,font=("Times new roman",20,"bold"))
                r1.grid(row=2,column=1,sticky="w")
                r2 = Radiobutton(framestaffinformationcenter,text="female",value='Female',bg="lightblue",variable=GenderSi,font=("Times new roman",20,"bold"))
                r2.grid(row=2,column=1,sticky="e",padx=0)
                GenderSi.set(3)


                labelPosition=Label(framestaffinformationcenter,text="Position:         ",bg="lightblue",font=("Times new roman",20,"bold"))
                labelPosition.grid(row=3,column=0,padx=10,pady=15)
                SiPosition=StringVar()
                Position=Entry(framestaffinformationcenter,textvariable=SiPosition,font=("Times new roman",20,"bold"))
                Position.grid(row=3,column=1,padx=0)

                labelDepartment=Label(framestaffinformationcenter,text="Department:         ",bg="lightblue",font=("Times new roman",20,"bold"))
                labelDepartment.grid(row=4,column=0,padx=10,pady=15)
                SiDepartment=StringVar()
                Department=Entry(framestaffinformationcenter,textvariable=SiDepartment,font=("Times new roman",20,"bold"))
                Department.grid(row=4,column=1,padx=0)

                labelMailid=Label(framestaffinformationcenter,text="Mail ID:         ",bg="lightblue",font=("Times new roman",20,"bold"))
                labelMailid.grid(row=5,column=0,padx=10,pady=15)
                SiMailid=StringVar()
                Mailid=Entry(framestaffinformationcenter,textvariable=SiMailid,font=("Times new roman",20,"bold"))
                Mailid.grid(row=5,column=1,padx=0)

                labelSalary=Label(framestaffinformationcenter,text="Salary:            ",bg="lightblue",font=("Times new roman",20,"bold"))
                labelSalary.grid(row=6,column=0,padx=10,pady=15)
                SiSalary=StringVar()
                Salary=Entry(framestaffinformationcenter,textvariable=SiSalary,font=("Times new roman",20,"bold"))
                Salary.grid(row=6,column=1,padx=0)

                labelPhone=Label(framestaffinformationcenter,text="Phone:           ",bg="lightblue",font=("Times new roman",20,"bold"))
                labelPhone.grid(row=7,column=0,padx=10,pady=15)

                SiPhone=StringVar()
                Phone=Entry(framestaffinformationcenter,textvariable=SiPhone,font=("Times new roman",20,"bold"))
                Phone.grid(row=7,column=1,padx=0)

                labelAddress=Label(framestaffinformationcenter,text="Address:         ",bg="lightblue",font=("Times new roman",20,"bold"))
                labelAddress.grid(row=8,column=0,padx=10,pady=15)

                SiAddress=StringVar()
                Address=Entry(framestaffinformationcenter,textvariable=SiAddress,font=("Times new roman",20,"bold"))
        ...
        def sreg():
            ...
            if countersreg==1:
                framestaffregistration=Frame(root,bg="lightblue")
                ...
                labelstaffregistration=Label(framestaffregistrationtop,text="Staff Registration",bg="sandybrown",font=("Times new roman",23,"bold"))
                labelstaffregistration.pack(anchor="center")

                framestaffregistrationcenter=Frame(framestaffregistration,height="60",width="130",relief="solid",bg="lightblue",borderwidth=2)
                framestaffregistrationcenter.pack(side=LEFT,fill=BOTH,expand=True)

                labelid=Label(framestaffregistrationcenter,text="ID:                 ",bg="lightblue",font=("Times new roman",21,"bold"))
                labelid.grid(row=0,column=0,padx=120,pady=15)

                SrID=StringVar()
                ID=Entry(framestaffregistrationcenter,textvariable=SrID,font=("Times new roman",20,"bold"))
                ID.grid(row=0,column=1,padx=0)

                labelName=Label(framestaffregistrationcenter,text="Name:            ",bg="lightblue",font=("Times new roman",21,"bold"))
                labelName.grid(row=1,column=0,padx=10,pady=15)
                
                SrName=StringVar()
                Name=Entry(framestaffregistrationcenter,textvariable=SrName,font=("Times new roman",20,"bold"))
                Name.grid(row=1,column=1,padx=0)

                GenderSr=StringVar()
                GenderSr.set("")

                labelGender=Label(framestaffregistrationcenter,text="Gender:          ",bg="lightblue",font=("Times new roman",21,"bold"))
                labelGender.grid(row=2,column=0)

                i= IntVar()
                r1 = Radiobutton(framestaffregistrationcenter,text="male",value="Male",bg="lightblue",variable=GenderSr,font=("Times new roman",20,"bold"))
                r2 = Radiobutton(framestaffregistrationcenter,text="female",value="Female",variable=GenderSr,bg="lightblue",font=("Times new roman",20,"bold"))
                r1.grid(row=2,column=1,sticky="w")
                r2.grid(row=2,column=1,sticky="e",padx=0)
                GenderSr.set(3)

                labelPosition=Label(framestaffregistrationcenter,text="Position:         ",bg="lightblue",font=("Times new roman",21,"bold"))
                labelPosition.grid(row=3,column=0,padx=10,pady=15)

                SrPosition=StringVar()
                Position=Entry(framestaffregistrationcenter,textvariable=SrPosition,font=("Times new roman",20,"bold"))
                Position.grid(row=3,column=1,padx=0)

                labelDepartment=Label(framestaffregistrationcenter,text="Department:         ",bg="lightblue",font=("Times new roman",21,"bold"))
                labelDepartment.grid(row=4,column=0,padx=10,pady=15)

                SrDepartment=StringVar()
                Department=Entry(framestaffregistrationcenter,textvariable=SrDepartment,font=("Times new roman",20,"bold"))
                Department.grid(row=4,column=1,padx=0)

                labelMailid=Label(framestaffregistrationcenter,text="Mail ID:         ",bg="lightblue",font=("Times new roman",21,"bold"))
                labelMailid.grid(row=5,column=0,padx=10,pady=15)

                SrMailid=StringVar()
                Mailid=Entry(framestaffregistrationcenter,textvariable=SrMailid,font=("Times new roman",20,"bold"))
                Mailid.grid(row=5,column=1,padx=0)

                labelSalary=Label(framestaffregistrationcenter,text="Salary:            ",bg="lightblue",font=("Times new roman",21,"bold"))
                labelSalary.grid(row=6,column=0,padx=10,pady=15)

                SrSalary=StringVar()
                Salary=Entry(framestaffregistrationcenter,textvariable=SrSalary,font=("Times new roman",20,"bold"))
                Salary.grid(row=6,column=1,padx=0)

                labelPhone=Label(framestaffregistrationcenter,text="Phone:           ",bg="lightblue",font=("Times new roman",21,"bold"))
                labelPhone.grid(row=7,column=0,padx=10,pady=15)

                SrPhone=StringVar()
                Phone=Entry(framestaffregistrationcenter,textvariable=SrPhone,font=("Times new roman",20,"bold"))
                Phone.grid(row=7,column=1,padx=0)

                labelAddress=Label(framestaffregistrationcenter,text="Address:         ",bg="lightblue",font=("Times new roman",21,"bold"))
                labelAddress.grid(row=8,column=0,padx=10,pady=15)

                SrAddress=StringVar()
                Address=Entry(framestaffregistrationcenter,textvariable=SrAddress,font=("Times new roman",20,"bold"))
                Address.grid(row=8,column=1,padx=0)
                ...
                framestaffregistrationright=Frame(framestaffregistration,height="60",width="300",bg="lightblue",relief="solid",borderwidth=2)
                framestaffregistrationright.pack(side=RIGHT,fill=Y)

                buttonAdd=Button(framestaffregistrationright,text="ADD",command=Sradd,bd=7,bg="yellow",width=10,font=("Times new roman",15,"bold"))
        ...
        def ainfo():
            ...
            if counterainfo==1: 
                frameainfo=Frame(root,width=100,height=100,bg="lightblue")
                ...
                labelpatientinfotext=Label(frameainfotop,text="Admit Information",bg="sandybrown",font=("Times new roman",23,"bold"))
                labelpatientinfotext.pack(anchor="center")

                frameainfoleft=Frame(frameainfo,height="60",width="300",relief="solid",bg="lightblue",borderwidth=2)
                frameainfoleft.pack(side=LEFT,fill=Y)

                labelinputpatientname=Label(frameainfoleft,text="Input Patient's ID",bg="lightblue",font=("Times new roman",17,"bold"))
                labelinputpatientname.pack(anchor=CENTER,pady=20)

                searchID=StringVar()
                inputpatientname=Entry(frameainfoleft,textvariable=searchID,width="20",font=("Times new roman",15,"bold"))
                inputpatientname.pack()

                Search1button=Button(frameainfoleft,text="Search",command=lambda: Aisearch(searchID.get()),bg="yellow",font=("Times new roman",15,"bold"))
                Search1button.pack(side=TOP,pady=8)

                frameainfocenter=Frame(frameainfo,height="60",width="130",relief="solid",bg="lightblue",borderwidth=2)
                frameainfocenter.pack(side=LEFT,fill=BOTH,expand=True)

                labelPatientid=Label(frameainfocenter,text="Patient ID:    ",bg="lightblue",font=("Times new roman",20,"bold"))
                labelPatientid.grid(row=0,column=0,pady=10,sticky="w")
                
                AiPatientid=StringVar()
                Patientid=Entry(frameainfocenter,textvariable=AiPatientid,font=("Times new roman",20,"bold"))
                Patientid.grid(row=0,column=1,padx=1,pady=17,sticky="w")
                
                labelPatientid=Label(frameainfocenter,text="",bg="lightblue",font=("Times new roman",20,"bold"))
                labelPatientid.grid(row=0,column=2,sticky="e")

                labelName=Label(frameainfocenter,text="Name:       ",bg="lightblue",font=("Times new roman",20,"bold"))
                labelName.grid(row=1,column=0,padx=0,pady=17,sticky="w")

                AiName=StringVar()
                Name=Entry(frameainfocenter,textvariable=AiName,font=("Times new roman",20,"bold"))
                Name.grid(row=1,column=1)

                GenderAi=StringVar()
                GenderAi.set("")

                labelGender=Label(frameainfocenter,text="Gender:        ",bg="lightblue",font=("Times new roman",20,"bold"))
                labelGender.grid(row=2,column=0)
                        
                i= IntVar()
                r1 = Radiobutton(frameainfocenter,text="male",value=1,variable=GenderAi,bg="lightblue",font=("Times new roman",20,"bold"))
                r2 = Radiobutton(frameainfocenter,text="female",value=2,variable=GenderAi,bg="lightblue",font=("Times new roman",20,"bold"))
                r1.grid(row=2,column=1,sticky="w")
                r2.grid(row=2,column=1,sticky="e",padx=0)
                GenderAi.set(3)

                labelAge=Label(frameainfocenter,text="Age:         ",bg="lightblue",font=("Times new roman",20,"bold"))
                labelAge.grid(row=3,column=0,sticky="w",padx=0,pady=17)

                AiAge=StringVar()
                Age=Entry(frameainfocenter,textvariable=AiAge,font=("Times new roman",20,"bold"))
                Age.grid(row=3,column=1)

                labelPhone=Label(frameainfocenter,text="Phone:     ",bg="lightblue",font=("Times new roman",20,"bold"))
                labelPhone.grid(row=4,column=0,sticky="w",padx=0,pady=17)

                AiPhone=StringVar()
                Phone=Entry(frameainfocenter,textvariable=AiPhone,font=("Times new roman",20,"bold"))
                Phone.grid(row=4,column=1)

                labelAddress=Label(frameainfocenter,text="Address:  ",bg="lightblue",font=("Times new roman",20,"bold"))
                labelAddress.grid(row=5,column=0,sticky="w",padx=0,pady=17)

                AiAddress=StringVar()
                Address=Entry(frameainfocenter,textvariable=AiAddress,font=("Times new roman",20,"bold"))
                Address.grid(row=5,column=1)

                labelDisease=Label(frameainfocenter,text="Disease:   ",bg="lightblue",font=("Times new roman",20,"bold"))
                labelDisease.grid(row=6,column=0,sticky="w",padx=0,pady=17)

                AiDisease=StringVar()
                Disease=Entry(frameainfocenter,textvariable=AiDisease,font=("Times new roman",20,"bold"))
                Disease.grid(row=6,column=1)

                labelCheckIn=Label(frameainfocenter,text="Check In",bg="lightblue",font=("Times new roman",20,"bold"))
                labelCheckIn.grid(row=7,column=0,sticky="w",padx=0,pady=17)

                AiCheckIn=StringVar()
                CheckIn=Entry(frameainfocenter,textvariable=AiCheckIn,font=("Times new roman",20,"bold"))
                ...
                frameainforight=Frame(frameainfo,height="60",width="300",relief="solid",borderwidth=2,bg="lightblue")
                frameainforight.pack(side=RIGHT,fill=Y)

                labelBloodgroup=Label(frameainforight,text="Blood Group",bg="lightblue",font=("Times new roman",17,"bold"))
                labelBloodgroup.pack(padx=80,pady=10)

                AiBloodgroup=StringVar()
                Bloodgroup=Entry(frameainforight,textvariable=AiBloodgroup,width="20",font=("Times new roman",17,"bold"))
                Bloodgroup.pack()

                labelDoctorname=Label(frameainforight,text="Doctor Name",bg="lightblue",font=("Times new roman",17,"bold"))
                labelDoctorname.pack(padx=80,pady=10)

                AiDoctorname=StringVar()
                Doctorname=Entry(frameainforight,textvariable=AiDoctorname,width="20",font=("Times new roman",17,"bold"))
                Doctorname.pack()

                labelCheckOut=Label(frameainforight,text="Check OUT",bg="lightblue",font=("Times new roman",17,"bold"))
                labelCheckOut.pack(pady=10)

                AiCheckOut=StringVar()
                CheckOut=Entry(frameainforight,textvariable=AiCheckOut,width="20",font=("Times new roman",17,"bold"))
                CheckOut.pack()

                labelRoomNo=Label(frameainforight,text="Room No.",bg="lightblue",font=("Times new roman",17,"bold"))
                labelRoomNo.pack(pady=10)

                AiRoomNo=StringVar()
                RoomNo=Entry(frameainforight,textvariable=AiRoomNo,width="20",font=("Times new roman",17,"bold"))
                RoomNo.pack()

                labelRoomType=Label(frameainforight,text="Room Type",bg="lightblue",font=("Times new roman",17,"bold"))
                ...
                labelPrice=Label(frameainforight,text="Price.",bg="lightblue",font=("Times new roman",17,"bold"))
                labelPrice.pack(pady=10)

                AiPrice=StringVar()
                Price=Entry(frameainforight,textvariable=AiPrice,width="20",font=("Times new roman",17,"bold"))
                Price.pack()

                Updatebutton=Button(frameainforight,text="Update",command=Aiupdate,bg="yellow",width=15,bd=7,font=("Times new roman",15,"bold"))
        ...
        def padmit():
            ...
            if counterpadmit==1:    
                framepatientadmit=Frame(root,width=100,bg="lightblue",height=100)
                framepatientadmit.pack(side="right",fill=BOTH,expand=TRUE)

                frameainfoleft=Frame(framepatientadmit,height="60",width="200",relief="solid",borderwidth=2,bg="lightblue")
                frameainfoleft.pack(side=LEFT,fill=Y)
                ...
                labelinputpatientname=Label(framepatientadmittop,text="Input Patient's ID",bg="sandybrown",font=("Times new roman",17,"bold"))
                labelinputpatientname.pack(anchor=CENTER,pady=10)

                framepatientadmittopsearch=Frame(frameainfoleft,bg="lightblue")
                framepatientadmittopsearch.pack(side=TOP)
                ...
                Searchbutton=Button(framepatientadmittopsearch,text="Search",command=lambda:Adsearch(searchID.get()),bg="yellow",font=("Times new roman",15,"bold"))
                Searchbutton.pack(side=TOP,pady=8)

                framepatientadmittop=Frame(framepatientadmit,height="200",relief="solid",borderwidth=2,bg="sandybrown")
                framepatientadmittop.pack(side=TOP,fill=X)

                labelpatientrinfotext=Label(framepatientadmittop,text="Patient Admit",bg="sandybrown",font=("Times new roman",23,"bold"))
                labelpatientrinfotext.pack(anchor="center")

                framepatientadmitcenter=Frame(framepatientadmit,height="60",width="130",bg="lightblue",relief="solid",borderwidth=2)
                framepatientadmitcenter.pack(side=LEFT,fill=BOTH,expand=True)

                labelPatientid=Label(framepatientadmitcenter,text="Patient ID:    ",bg="lightblue",font=("Times new roman",20,"bold"))
                labelPatientid.grid(row=0,column=0,padx=40,pady=10,sticky="w")
                
                PaPatientid=StringVar()
                Patientid=Entry(framepatientadmitcenter,textvariable=PaPatientid,font=("Times new roman",20,"bold"))
                Patientid.grid(row=0,column=1,padx=1,pady=17,sticky="w")

                labelName=Label(framepatientadmitcenter,text="Name:       ",bg="lightblue",font=("Times new roman",20,"bold"))
                labelName.grid(row=1,column=0,padx=40,pady=17,sticky="w")

                PaName=StringVar()
                Name=Entry(framepatientadmitcenter,textvariable=PaName,font=("Times new roman",20,"bold"))
                Name.grid(row=1,column=1)

                GenderPa=StringVar()
                GenderPa.set("")

                labelGender=Label(framepatientadmitcenter,text="Gender:        ",bg="lightblue",font=("Times new roman",20,"bold"))
                labelGender.grid(row=2,column=0)
                        
                i= IntVar()
                r1 = Radiobutton(framepatientadmitcenter,text="male",value=1,variable=GenderPa,bg="lightblue",font=("Times new roman",20,"bold"))
                r2 = Radiobutton(framepatientadmitcenter,text="female",value=2,variable=GenderPa,bg="lightblue",font=("Times new roman",20,"bold"))
                r1.grid(row=2,column=1,sticky="w")
                r2.grid(row=2,column=1,sticky="e",padx=0)
                GenderPa.set(3)

                labelAge=Label(framepatientadmitcenter,text="Age:         ",bg="lightblue",font=("Times new roman",20,"bold"))
                labelAge.grid(row=3,column=0,sticky="w",padx=40,pady=17)

                PaAge=StringVar()
                Age=Entry(framepatientadmitcenter,textvariable=PaAge,font=("Times new roman",20,"bold"))
                Age.grid(row=3,column=1)

                labelPhone=Label(framepatientadmitcenter,text="Phone:     ",bg="lightblue",font=("Times new roman",20,"bold"))
                labelPhone.grid(row=4,column=0,sticky="w",padx=40,pady=17)

                PaPhone=StringVar()
                Phone=Entry(framepatientadmitcenter,textvariable=PaPhone,font=("Times new roman",20,"bold"))
                Phone.grid(row=4,column=1)

                labelAddress=Label(framepatientadmitcenter,text="Address:  ",bg="lightblue",font=("Times new roman",20,"bold"))
                labelAddress.grid(row=5,column=0,padx=40,pady=17,sticky="w")

                PaAddress=StringVar()
                Address=Entry(framepatientadmitcenter,textvariable=PaAddress,font=("Times new roman",20,"bold"))
                Address.grid(row=5,column=1)

                labelDisease=Label(framepatientadmitcenter,text="Disease:   ",bg="lightblue",font=("Times new roman",20,"bold"))
                labelDisease.grid(row=6,column=0,padx=40,pady=17,sticky="w")

                PaDisease=StringVar()
                Disease=Entry(framepatientadmitcenter,textvariable=PaDisease,font=("Times new roman",20,"bold"))
                Disease.grid(row=6,column=1)

                labelCheckIn=Label(framepatientadmitcenter,text="Check In",bg="lightblue",font=("Times new roman",20,"bold"))
                labelCheckIn.grid(row=7,column=0,padx=40,pady=17,sticky="w")

                PaCheckIn=StringVar()
                CheckIn=Entry(framepatientadmitcenter,textvariable=PaCheckIn,font=("Times new roman",20,"bold"))
                CheckIn.grid(row=7,column=1)
                ...
                framepatientadmitright=Frame(framepatientadmit,height="60",width="300",relief="solid",bg="lightblue",borderwidth=2)
                framepatientadmitright.pack(side=RIGHT,fill=Y)

                labelBloodgroup=Label(framepatientadmitright,text="Blood group",bg="lightblue",font=("Times new roman",17,"bold"))
                labelBloodgroup.pack(padx=80,pady=10)

                PaBloodgroup=StringVar()
                Bloodgroup=Entry(framepatientadmitright,textvariable=PaBloodgroup,width="20",font=("Times new roman",17,"bold"))
                Bloodgroup.pack()

                labelDoctorname=Label(framepatientadmitright,text="Doctor Name",bg="lightblue",font=("Times new roman",17,"bold"))
                labelDoctorname.pack(padx=80,pady=10)

                PaDoctorname=StringVar()
                Doctorname=Entry(framepatientadmitright,textvariable=PaDoctorname,width="20",font=("Times new roman",17,"bold"))
                Doctorname.pack()

                labelCheckOut=Label(framepatientadmitright,text="Check OUT",bg="lightblue",font=("Times new roman",17,"bold"))
                labelCheckOut.pack(pady=10)

                PaCheckOut=StringVar()
                CheckOut=Entry(framepatientadmitright,textvariable=PaCheckOut,width="20",font=("Times new roman",17,"bold"))
                CheckOut.pack()

                labelRoomNo=Label(framepatientadmitright,text="Room No.",bg="lightblue",font=("Times new roman",17,"bold"))
                labelRoomNo.pack(pady=10)

                PaRoomNo=StringVar()
                RoomNo=Entry(framepatientadmitright,textvariable=PaRoomNo,width="20",font=("Times new roman",17,"bold"))
                RoomNo.pack()

                labelRoomType=Label(framepatientadmitright,text="Room Type",bg="lightblue",font=("Times new roman",17,"bold"))
                labelRoomType.pack(pady=10)
                ...
                labelPrice=Label(framepatientadmitright,text="Price.",bg="lightblue",font=("Times new roman",17,"bold"))
                labelPrice.pack(pady=10)

                PaPrice=StringVar()
                Price=Entry(framepatientadmitright,textvariable=PaPrice,width="20",font=("Times new roman",17,"bold"))
                Price.pack()

                ADDAbutton=Button(framepatientadmitright,text="ADD",command=Paadd,bg="yellow",width=15,bd=7,font=("Times new roman",15,"bold"))
        ...
        def rinfo():
            ...
            if counterrinfo==1: 
                ...
                labelpatientrinfotext=Label(framerinfotop,text="Registration Information",bg="sandybrown",font=("Times new roman",23,"bold"))
                labelpatientrinfotext.pack(anchor="center")

                framerinfoleft=Frame(framerinfo,height="60",width="300",relief="solid",borderwidth=2,bg="lightblue")
                framerinfoleft.pack(side=LEFT,fill=Y)

                labelinputpatientname=Label(framerinfoleft,text="Input Patient's ID",bg="lightblue",font=("Times new roman",17,"bold"))
                labelinputpatientname.pack(anchor=CENTER,pady=20)

                searchID=StringVar()
                inputpatientname=Entry(framerinfoleft,textvariable=searchID,width="20",font=("Times new roman",15,"bold"))
                inputpatientname.pack()

                Searchbutton=Button(framerinfoleft,text="Search",command=lambda:Risearch(searchID.get()),bg="yellow",font=("Times new roman",15,"bold"))
                Searchbutton.pack(side=TOP,pady=8)

                framerinfocenter=Frame(framerinfo,height="60",width="130",bg="lightblue",relief="solid",borderwidth=2)
                framerinfocenter.pack(side=LEFT,fill=BOTH,expand=True)

                labelPatientid=Label(framerinfocenter,text="Patient ID:    ",bg="lightblue",font=("Times new roman",20,"bold"))
                labelPatientid.grid(row=0,column=0,pady=10,sticky="w")
                
                RiPatientid=StringVar()
                Patientid=Entry(framerinfocenter,textvariable=RiPatientid,font=("Times new roman",20,"bold"))
                Patientid.grid(row=0,column=1,padx=1,pady=17,sticky="w")
                
                labelPatientid=Label(framerinfocenter,text="",bg="lightblue",font=("Times new roman",20,"bold"))
                labelPatientid.grid(row=0,column=2,sticky="e")

                labelName=Label(framerinfocenter,text="Name:       ",bg="lightblue",font=("Times new roman",20,"bold"))
                labelName.grid(row=1,column=0,padx=0,pady=17,sticky="w")

                RiName=StringVar()
                Name=Entry(framerinfocenter,textvariable=RiName,font=("Times new roman",20,"bold"))
                Name.grid(row=1,column=1)

                GenderRi=StringVar()
                GenderRi.set("")

                labelGender=Label(framerinfocenter,text="Gender:        ",bg="lightblue",font=("Times new roman",20,"bold"))
                labelGender.grid(row=2,column=0)
                        
                
                r1 = Radiobutton(framerinfocenter,text="male",value='Male',variable=GenderRi,bg="lightblue",font=("Times new roman",20,"bold"))
                r1.grid(row=2,column=1,sticky="w")
                r2 = Radiobutton(framerinfocenter,text="female",value='Female',variable=GenderRi,bg="lightblue",font=("Times new roman",20,"bold"))
                r2.grid(row=2,column=1,sticky="e",padx=0)
                GenderRi.set(3)


                labelAge=Label(framerinfocenter,text="Age:         ",bg="lightblue",font=("Times new roman",20,"bold"))
                labelAge.grid(row=3,column=0,sticky="w",padx=0,pady=17)

                RiAge=StringVar()
                Age=Entry(framerinfocenter,textvariable=RiAge,font=("Times new roman",20,"bold"))
                Age.grid(row=3,column=1)

                labelPhone=Label(framerinfocenter,text="Phone:     ",bg="lightblue",font=("Times new roman",20,"bold"))
                labelPhone.grid(row=4,column=0,sticky="w",padx=0,pady=17)

                RiPhone=StringVar()
                Phone=Entry(framerinfocenter,textvariable=RiPhone,font=("Times new roman",20,"bold"))
                Phone.grid(row=4,column=1)

                labelAddress=Label(framerinfocenter,text="Address:  ",bg="lightblue",font=("Times new roman",20,"bold"))
                labelAddress.grid(row=5,column=0,sticky="w",padx=0,pady=17)

                RiAddress=StringVar()
                Address=Entry(framerinfocenter,textvariable=RiAddress,font=("Times new roman",20,"bold"))
                Address.grid(row=5,column=1)

                labelDisease=Label(framerinfocenter,text="Disease:   ",bg="lightblue",font=("Times new roman",20,"bold"))
                labelDisease.grid(row=6,column=0,sticky="w",padx=0,pady=17)

                RiDisease=StringVar()
                Disease=Entry(framerinfocenter,textvariable=RiDisease,font=("Times new roman",20,"bold"))
                Disease.grid(row=6,column=1)

                labelCheckIn=Label(framerinfocenter,text="Check In",bg="lightblue",font=("Times new roman",20,"bold"))
                labelCheckIn.grid(row=7,column=0,sticky="w",padx=0,pady=17)

                RiCheckIn=StringVar()
                CheckIn=Entry(framerinfocenter,textvariable=RiCheckIn,font=("Times new roman",20,"bold"))
                CheckIn.grid(row=7,column=1)
                ...
                framerinforight=Frame(framerinfo,height="60",width="300",bg="lightblue",relief="solid",borderwidth=2)
                framerinforight.pack(side=RIGHT,fill=Y)

                labelDoctorname=Label(framerinforight,text="Blood Group",bg="lightblue",font=("Times new roman",17,"bold"))
                labelDoctorname.pack(padx=80,pady=10)

                RiBloodgroup=StringVar()
                Bloodgroup=Entry(framerinforight,textvariable=RiBloodgroup  ,width="20",font=("Times new roman",17,"bold"))
                Bloodgroup.pack()

                labelDoctorname=Label(framerinforight,text="Doctor Name",bg="lightblue",font=("Times new roman",17,"bold"))
                labelDoctorname.pack(padx=80,pady=10)

                RiDoctorname=StringVar()
                Doctorname=Entry(framerinforight,textvariable=RiDoctorname  ,width="20",font=("Times new roman",17,"bold"))
                Doctorname.pack()

                labelDoctorname=Label(framerinforight,text="Room No",bg="lightblue",font=("Times new roman",17,"bold"))
                labelDoctorname.pack(padx=80,pady=10)

                RiRoomNo=StringVar()
                RoomNo=Entry(framerinforight,textvariable=RiRoomNo,width="20",font=("Times new roman",17,"bold"))
                RoomNo.pack()

                Updatebutton=Button(framerinforight,text="Update",command=Riupdate,bg="yellow",bd=7,font=("Times new roman",15,"bold"))
                Updatebutton.pack(side=RIGHT,padx=35,pady=100)

                Updatebutton=Button(framerinforight,text="Receipt",command=Rireceipt,bg="yellow",bd=7,font=("Times new roman",15,"bold"))
                Updatebutton.pack(side=RIGHT,padx=35,pady=100)
        ...
        def Receipt():
            ...
            try:
                ...
                pass
            if counterreceipt==1:
                framereceiptimage=Frame(root,bg="lightblue")
                ...
                label=Label(framereceiptimage,text="Atul Nagar Warje, Pune Maharashtra",font=("Times new roman",15,"bold"),bg="lightblue")
                ...
                framereceipt=Frame(root,bg="lightblue")
                framereceipt.pack(side="top",fill=BOTH,expand=True)

                

                framereceipttop=Frame(framereceipt,bg="lightblue",height=20)
                framereceipttop.pack(side=TOP,fill=X)

                labelreceipt=Label(framereceipttop,text="Receipt :-",bg="lightblue",fg="black",font=('arial',20,'bold'))
                labelreceipt.pack(side=LEFT,padx=150,pady=10)

                txtReceipt=Text(framereceipt,width=65,height=12,bg='orange',bd=4,font=('arial',12,'bold'))
                ...
                labelreceipt=Label(framereceipt,text="Medicine: - ",fg="black",bg="lightblue",font=('arial',20,'bold'))
        ...
        def Rireceipt():
            ...
            if counterrireceipt==1:
                framerireceiptimage=Frame(root,bg="lightblue")
                ...
                label=Label(framerireceiptimage,text="Atul nagar near Raghavdas Vidhyalaya Warje-Malwadi Pune 411058",font=("Times new roman",15,"bold"),bg="lightblue")
                label.grid(row=0,column=1,padx=200)
                ...
                framerireceipt=Frame(root,bg="lightblue")
                framerireceipt.pack(side="top",fill=BOTH,expand=True)

                

                framerireceipttop=Frame(framerireceipt,bg="lightblue",height=20)
                framerireceipttop.pack(side=TOP,fill=X)

                labelreceipt=Label(framerireceipttop,text="Receipt :-",bg="lightblue",fg="black",font=('arial',20,'bold'))
                labelreceipt.pack(side=LEFT,padx=150,pady=10)

                txtReceipt=Text(framerireceipt,width=65,height=12,bg='orange',bd=4,font=('arial',12,'bold'))
                txtReceipt.pack(anchor="nw",padx=100)
                ...
                labelreceipt=Label(framerireceipt,text="Medicine: - ",fg="black",bg="lightblue",font=('arial',20,'bold'))
                labelreceipt.pack(anchor="nw",padx=150,pady=10)
        ...
        def printbill():
            ...
            if counterprintbill==1:
                frameprintbill=Frame(root,bg="lightblue")
                frameprintbill.pack(side="top",fill=BOTH,expand=True)

                txtReceiptbill=Text(frameprintbill,width=100,height=17,bg='orange',bd=4,font=('arial',12,'bold'))
        ...
        def preg():
            ...
            if counterpreg==1:
                framepatientregistration=Frame(root,width=100,height=100,bg="lightblue")
                ...
                labelpatientregistrationtext=Label(framepatientregistrationtop,text="Patient Registration",bg="sandybrown",font=("Times new roman",23,"bold"))
                labelpatientregistrationtext.pack(anchor="center")

                framepatientregistrationcenter=Frame(framepatientregistration,bg="lightblue",height="60",width="130",relief="solid",borderwidth=2)
                framepatientregistrationcenter.pack(side=LEFT,fill=BOTH,expand=True)

                labelPatientid=Label(framepatientregistrationcenter,bg="lightblue",text="Patient ID:    ",font=("Times new roman",20,"bold"))
                labelPatientid.grid(row=0,column=0,padx=90,pady=10,sticky="w")
                
                PrPatientid=StringVar()
                Patientid=Entry(framepatientregistrationcenter,textvariable=PrPatientid,font=("Times new roman",20,"bold"))
                Patientid.grid(row=0,column=1,padx=1,pady=17,sticky="w")
                
                labelName=Label(framepatientregistrationcenter,text="Name:       ",bg="lightblue",font=("Times new roman",20,"bold"))
                labelName.grid(row=1,column=0,padx=90,pady=17,sticky="w")

                PrName=StringVar()
                Name=Entry(framepatientregistrationcenter,textvariable=PrName,font=("Times new roman",20,"bold"))
                Name.grid(row=1,column=1)

                GenderPr=StringVar()
                GenderPr.set("")

                labelGender=Label(framepatientregistrationcenter,text="Gender:    ",bg="lightblue",font=("Times new roman",20,"bold"))
                labelGender.grid(row=2,column=0,sticky="w",padx=90)

                i= IntVar()
                r1 = Radiobutton(framepatientregistrationcenter,text="male",value="Male",bg="lightblue",variable=GenderPr,font=("Times new roman",20,"bold"))
                r2 = Radiobutton(framepatientregistrationcenter,text="female",value="Female",bg="lightblue",variable=GenderPr,font=("Times new roman",20,"bold"))
                r1.grid(row=2,column=1,sticky="w")
                r2.grid(row=2,column=1,sticky="e",padx=0)
                GenderPr.set(3)

                labelAge=Label(framepatientregistrationcenter,text="Age:         ",bg="lightblue",font=("Times new roman",20,"bold"))
                labelAge.grid(row=3,column=0,sticky="w",padx=90,pady=17)

                PrAge=StringVar()
                Age=Entry(framepatientregistrationcenter,textvariable=PrAge,font=("Times new roman",20,"bold"))
                Age.grid(row=3,column=1)

                labelPhone=Label(framepatientregistrationcenter,text="Phone:     ",bg="lightblue",font=("Times new roman",20,"bold"))
                labelPhone.grid(row=4,column=0,sticky="w",padx=90,pady=17)

                PrPhone=StringVar()
                Phone=Entry(framepatientregistrationcenter,textvariable=PrPhone,font=("Times new roman",20,"bold"))
                Phone.grid(row=4,column=1)

                labelAddress=Label(framepatientregistrationcenter,text="Address:  ",bg="lightblue",font=("Times new roman",20,"bold"))
                labelAddress.grid(row=5,column=0,sticky="w",padx=90,pady=17)

                PrAddress=StringVar()
                Address=Entry(framepatientregistrationcenter,textvariable=PrAddress,font=("Times new roman",20,"bold"))
                Address.grid(row=5,column=1)

                labelDisease=Label(framepatientregistrationcenter,text="Disease:   ",bg="lightblue",font=("Times new roman",20,"bold"))
                labelDisease.grid(row=6,column=0,sticky="w",padx=90,pady=17)

                PrDisease=StringVar()
                Disease=Entry(framepatientregistrationcenter,textvariable=PrDisease,font=("Times new roman",20,"bold"))
                Disease.grid(row=6,column=1)

                labelCheckIn=Label(framepatientregistrationcenter,text="Check IN",bg="lightblue",font=("Times new roman",20,"bold"))
                labelCheckIn.grid(row=7,column=0,sticky="w",padx=90,pady=17)


                CheckIn=Entry(framepatientregistrationcenter,textvariable=PrCheckIn,font=("Times new roman",20,"bold"))
                CheckIn.grid(row=7,column=1)
                ...
                framepatientregistrationright=Frame(framepatientregistration,height="60",width="300",bg="lightblue",relief="solid",borderwidth=2)
                framepatientregistrationright.pack(side=RIGHT,fill=Y)

                labelBloodgroup=Label(framepatientregistrationright,text="Blood Group",bg="lightblue",font=("Times new roman",17,"bold"))
                labelBloodgroup.pack(pady=10)

                PrBloodgroup=StringVar()
                Bloodgroup=Entry(framepatientregistrationright,textvariable=PrBloodgroup    ,width="20",font=("Times new roman",17,"bold"))
                Bloodgroup.pack()

                labelDoctorname=Label(framepatientregistrationright,text="Doctor Name",bg="lightblue",font=("Times new roman",17,"bold"))
                labelDoctorname.pack(pady=10)

                list=["Rajesh[Dentist]","Deepti[Homeopathy]","Vishal[Cardiologist]","Gourav[Pediatricians]","Gourav[Physician]","Vijay[Therapist]","Karan[Diagnostic]"]
                ...
                labelRoomNo=Label(framepatientregistrationright,text="Room No.",bg="lightblue",font=("Times new roman",17,"bold"))
                labelRoomNo.pack(pady=10)

                PrRoomNo=StringVar()
                RoomNo=Entry(framepatientregistrationright,textvariable=PrRoomNo,width="20",font=("Times new roman",17,"bold"))
                RoomNo.pack(padx=5)

                ADDAbutton=Button(framepatientregistrationright,text="ADD",command=Pradd,bg="yellow",width=10,bd=7,font=("Times new roman",15,"bold"))
                ADDAbutton.pack(side=LEFT,padx=5)

                buttonprintreg=Button(framepatientregistrationright,text="Receipt",command=Receipt,bg="yellow",width=10,bd=7,font=("Times new roman",15,"bold"))
                buttonprintreg.pack(side=LEFT,padx=5)

        framemenuroot=Frame(root,height="190",bg="lightblue")
        framemenuroot.pack(side=TOP,fill=X)
        framehospitalname=Label(framemenuroot,text="                                  HOMEOPATHY CLINIC",bg="lightblue",fg="blue",width="35",font=("Times new roman",27,"italic"))
        ...
        framemenubackground=Frame(root,bg="lightblue",height="60",width="50")
        framemenubackground.pack(side=LEFT,fill=Y)
        framemenuheading=Label(framemenubackground,text="Menu",fg="Orange",bg="sandybrown",width="25",font=("Times new roman",18,"bold"))
        framemenuheading.pack(anchor="nw")

        homeicon=PhotoImage(file=r"home.png")
        Buttonpatienthome=Button(framemenubackground,text="Home            ",compound=LEFT,image=homeicon,command=home,bd=5,bg="sandybrown",font=("Times new roman",14,"bold"))
        Buttonpatienthome.pack(side="top",fill=X)

        patientregistrationicon=PhotoImage(file=r"patientregistration.png")
        Buttonpatientregistration=Button(framemenubackground,text="Patient Registration         ",compound=LEFT,image=patientregistrationicon,command=preg,bd=5,bg="sandybrown",font=("Times new roman",14,"bold"))
        Buttonpatientregistration.pack(side="top",fill=X)

        patientadmiticon=PhotoImage(file=r"patientadmit.png")
        Buttonpatientinformation=Button(framemenubackground,text="Patient Admit                     ",compound=LEFT,image=patientadmiticon,command=padmit,bd=5,bg="sandybrown",font=("Times new roman",14,"bold"))
        Buttonpatientinformation.pack(side="top",fill=X)

        registrationinformationicon=PhotoImage(file=r"patientinformation.png")
        Buttonregistrationinfo=Button(framemenubackground,text="Registration Information",compound=LEFT,image=registrationinformationicon,command=rinfo,bd=5,bg="sandybrown",font=("Times new roman",14,"bold"))
        Buttonregistrationinfo.pack(side="top",fill=X)

        admitinformationicon=PhotoImage(file=r"patientadmit.png")
        Buttonadmitinformation=Button(framemenubackground,text="Admit Information            ",compound=LEFT,image=admitinformationicon,command=ainfo,bd=5,bg="sandybrown",font=("Times new roman",14,"bold"))
        Buttonadmitinformation.pack(side="top",fill=X)

        doctorregistrationicon=PhotoImage(file=r"doctorregistration.png")
        Buttonstaffregistration=Button(framemenubackground,text="Staff Registration              ",compound=LEFT,image=doctorregistrationicon,command=sreg,bd=5,bg="sandybrown",font=("Times new roman",14,"bold"))
        Buttonstaffregistration.pack(side="top",fill=X)

        doctorinformationicon=PhotoImage(file=r"doctorinformation.png")
        Buttonstaffinformation=Button(framemenubackground,text="Staff Information               ",compound=LEFT,image=doctorinformationicon,command=sinfo,bd=5,bg="sandybrown",font=("Times new roman",14,"bold"))
        Buttonstaffinformation.pack(side="top",fill=X)

        registrationrecordicon=PhotoImage(file=r"registrationrecord.png")
        ButtonRegistrationRecord=Button(framemenubackground,text="Registration Record         ",compound=LEFT,image=registrationrecordicon,command=RRecord,bd=5,bg="sandybrown",font=("Times new roman",14,"bold"))
        ButtonRegistrationRecord.pack(side="top",fill=X)

        admitrecordicon=PhotoImage(file=r"admitrecord.png")
        ButtonAdmitRecord=Button(framemenubackground,text="Admit Record                    ",compound=LEFT,image=admitrecordicon,command=AdmitRecord,bd=5,bg="sandybrown",font=("Times new roman",14,"bold"))
        ButtonAdmitRecord.pack(side="top",fill=X)

        doctorrecordicon=PhotoImage(file=r"doctorrecord.png")
        ButtonStaffRecord=Button(framemenubackground,text="Staff Record                        ",compound=LEFT,image=doctorrecordicon,command=drecord,bd=5,bg="sandybrown",font=("Times new roman",14,"bold"))
        ButtonStaffRecord.pack(side="top",fill=X)

        generatebillicon=PhotoImage(file=r"generatebill.png")
        ButtonBill=Button(framemenubackground,text="Generate Bill                       ",compound=LEFT,image=generatebillicon,command=Bill,bd=5,bg="sandybrown",font=("Times new roman",14,"bold"))
        ButtonBill.pack(side="top",fill=X)

        billrecordicon=PhotoImage(file=r"recordbill.png")
        ButtonBill=Button(framemenubackground,text="Bill Record                             ",compound=LEFT,image=billrecordicon,command=billrecord,bd=5,bg="sandybrown",font=("Times new roman",14,"bold"))
        ButtonBill.pack(side="top",fill=X)

        appointmenticon=PhotoImage(file=r"appointment.png")
        Buttonappointment=Button(framemenubackground,text="Appointment                       ",compound=LEFT,image=appointmenticon,bd=5,bg="sandybrown",font=("Times new roman",14,"bold"),command=appointment)
...
labelUsername=Label(userright,text="Username:",compound=LEFT,image=usernameicon,font=("Times new roman",18,"bold"),bg="pink")
labelUsername.pack(anchor="nw",padx=10)
usernameVar=StringVar()
UsernameEntry=Entry(userright,font=("Times new roman",14,"bold"),textvariable=usernameVar)
UsernameEntry.pack(anchor="nw",padx=10)

passwordicon=PhotoImage(file=r"password.png")
labelPassword=Label(userright,text="Password:",compound=LEFT,image=passwordicon,font=("Times new roman",18,"bold"),bg="pink")
labelPassword.pack(anchor="nw",padx=10)

passwordVar=StringVar()
userEntry=Entry(userright)
Passwordentry=Entry(userright,show="*",font=("Times new roman",14,"bold"),textvariable=passwordVar)
Passwordentry.pack(anchor="nw",padx=10)




buttonok=Button(userright,text="LOGIN",bg="orange",height=2,width=6,bd=3,font=("Times new roman",12,"bold"),command=login)
buttonok.pack(side=LEFT,padx="10",pady="10")

buttonexit=Button(userright,text="EXIT",bg="orange",height=2,width=6,bd=3,font=("Times new roman",12,"bold"),command=exit)
